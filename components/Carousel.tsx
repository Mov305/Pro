...
function dragElement(elmnt: any) {
    ...
    var pos1 = 0, pos3 = 0;
    if (typeof window !== 'undefined' && elmnt) {
...
const Carousel: FunctionComponent<{ type: string, items: any }> = ({ type, items }) => {
    ...
    return (
        <div className="mb-5">
            ...
            <div className="my-1 w-full bg-gradient-to-br min-h-[155px] from-violet-700 to-red-500 overflow-x-scroll  overflow-hidden no-scrollbar lg:overflow-hidden rounded-xl  shadow-md relative ">
